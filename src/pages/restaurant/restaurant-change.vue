...
import { updateRestaurant, getRestaurantById } from '@/services/axios/api/api'
...
getRestaurantById(route.params.restaurantId).then(res => {
    console.log(res);
    ...
    image.value = res.data.data.thumbnail
...
const handleSubmit = (id) => {
    ...
    updateRestaurant(formData, id).then(res => {
        console.log(res);
                        ...
                        <VRow>
                            ...
                            <VCol cols="12">
                                ...
                                <div style="height: 500px;" v-if="init_point.lat != null && init_point.lng != null">
                                    <MapLeaf :_click_map="onClickMap" :init_point="init_point" />
                            ...
                            <VCol cols="12" class="d-flex flex-column">
                                <v-checkbox class="m-4 w-25" color="error" label="Xác nhận thay đổi"
                                    v-model="confirmSubmit">

                                </v-checkbox>
                                <VBtn :loading="loading" class="mt-4" width="100px" color="success"
                                    :disabled="!confirmSubmit" @click="handleSubmit(route.params.restaurantId)">
                                    Thay Đổi
                                </VBtn>
